...
from app.schemas.user import MemberDetailResponse, UserDetailResponse, UserSchema
...
async def get_membership(
    ...
    return await membership_service.get_membership(data.user_id, data.company_id)
...
async def delete_membership(
    ...
    await membership_service.delete_membership(data.user_id, data.company_id)
...
async def delete_membership_request(
    ...
    await membership_service.cancel_membership_request(data.user_id, data.company_id)
    return ResponseModel(
